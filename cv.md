...
**Senior Software Engineer with over 8 years of cross-industry experience spanning Team Lead, Full-Stack IT Consulting, and Founding Engineer. Among other things, I co-built a product from 0 to production alongside my engineering career. Currently at SafeNow, building free safety tools now in the hands of over 1 million people worldwide. I care deeply about software craftsmanship, architecture, and scalability and I am always looking to learn new things.** 

[Skills](https://old.reddit.com/r/EngineeringResumes/wiki/index#wiki_skills)  
**Languages:** Kotlin, Java, Go, TypeScript, JavaScript, Ruby  
**Data:** PostgreSQL, Redis, Kafka, MongoDB, MQTT  
**Frameworks:** Spring Boot, Ktor, Next.js, Vue.js, Rails  
**APIs:** REST, GraphQL  
**AI/LLM**: Claude Code, Copilot  
**Infrastructure:** AWS, Docker, Helm, Kubernetes, Grafana  
**Architecture:** Hexagonal, Event-Driven, Microservices  
**Tools**: PostHog, Hasura, Gradle, Maven  
**Sideproject**: Godot, GDScript

[Experience](https://old.reddit.com/r/EngineeringResumes/wiki/index#wiki_work_experience)  
**Senior Software Engineer,** SafeNow	Dec 2024 [– Present](https://www.reddit.com/r/EngineeringResumes/wiki/index#wiki_dates)  
Working on the backend of SafeNow, scaled to over 1 million downloads across app stores:

* Advanced the resiliency of the backend systems to help grow to millions of requests handled each day  
* Introduced a world map of SafeNow usage to show the impact our app has in real-time helping the CEO display our reach to investors  
...
**IT Consultant,** Netlight	Dec 2023 [–](https://www.reddit.com/r/EngineeringResumes/wiki/index#wiki_dates) Dec 2024  
...
**Senior Software Developer,** ProSiebenSat.1 Tech Solutions	Oct 2022 – Dec 2023
...
* Revamped the Pull Request process reducing misunderstandings, speeding up the process, and minimizing follow-up questions

**Software Developer,** ProSiebenSat.1 Tech Solutions	Nov 2020 – Oct 2022
...
**Software Engineer,** ASAP Engineering GmbH	Feb 2018 – Nov 2020
...
**Founding Engineer (Part-Time),** Supplystudios GmbH	Nov 2018 – Mar 2023
...
**Research Assistant,** University of Tübingen	June 2015 – May 2017
...
[Education](https://old.reddit.com/r/EngineeringResumes/wiki/index#wiki_education)  
